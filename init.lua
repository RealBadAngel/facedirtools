minetest.register_tool("facedirtools:screwdriver", {
	description = "Screwdriver",
	inventory_image = "facedirtools_screwdriver.png",
...
for i=1,4,1 do
minetest.register_tool("facedirtools:screwdriver"..i, {
	description = "Screwdriver in Mode "..i,
	inventory_image = "facedirtools_screwdriver"..i..".png",
	wield_image = "facedirtools_screwdriver.png",
...
--look dir   +X  +Y  +Z     -Z  -Y  -X
		     2 , 0 , 4 ,    5 , 1 , 3 ,  -- rotate over y+ 0 - 3
		     4 , 0 , 3 ,    2 , 1 , 5 ,
		     3 , 0 , 5 ,    4 , 1 , 2 ,
		     5 , 0 , 2 ,    3 , 1 , 4 ,

		     3 , 5 , 0 ,    1 , 4 , 2 ,  -- rotate over z+ 4 - 7
		     5 , 3 , 0 ,    1 , 2 , 4 ,
		     3 , 4 , 0 ,    1 , 5 , 2 ,
		     4 , 2 , 0 ,    1 , 3 , 5 ,

		     2 , 5 , 1 ,    0 , 4 , 3 ,  -- rotate over z- 8 - 11
		     5 , 2 , 1 ,    0 , 3 , 4 ,
		     3 , 4 , 1 ,    0 , 5 , 2 ,
		     4 , 3 , 1 ,    0 , 2 , 5 ,

		     0 , 5 , 2 ,    3 , 4 , 1 ,  -- rotate over x+ 12 - 15
		     0 , 3 , 5 ,    4 , 2 , 1 ,
		     0 , 4 , 3 ,    2 , 5 , 1 ,
		     0 , 2 , 4 ,    5 , 3 , 1 ,

		     1 , 5 , 3 ,    2 , 4 , 0 ,  -- rotate over x- 16 - 19  
		     1 , 2 , 5 ,    4 , 3 , 0 ,  
		     1 , 4 , 2 ,    3 , 5 , 0 ,  
		     1 , 3 , 4 ,    5 , 2 , 0 ,  
		
		     3 , 1 , 4 ,    5 , 0 , 2 ,  -- rotate over y- 20 - 23
		     4 , 1 , 2 ,    3 , 0 , 5 ,  
		     2 , 1 , 5 ,    4 , 0 , 3 ,  
		     5 , 1 , 3 ,    2 , 0 , 4  
}
...
item["name"]="facedirtools:screwdriver"..mode
...
output = "facedirtools:screwdriver",
recipe = {
{"default:steel_ingot"},
{"default:stick"}
}
